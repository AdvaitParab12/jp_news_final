...
export default function HomeBottomAdBlock({ images }) {
  ...
  const imageUrls = useMemo(() => {
    ...
    if (urls.length > 0) {
      console.log("HomeBottomAdBlock - Image URLs:", urls);
    }
  ...
  if (!imageUrls || imageUrls.length === 0) {
    console.log("HomeBottomAdBlock - No images to display");
    return null;
  }
  ...
  return (
    <div className="relative h-64 md:h-165 mb-2 bg-gray-200">
      {/* Slider Image */}
