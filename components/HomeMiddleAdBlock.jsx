...
export default function HomeMiddleAdBlock({ images }) {
  ...
  const imageUrls = useMemo(() => {
    ...
    if (urls.length > 0) {
      console.log("HomeMiddleAdBlock - Image URLs:", urls);
    }
  ...
  if (!imageUrls || imageUrls.length === 0) {
    console.log("HomeMiddleAdBlock - No images to display");
    return null;
  }
  ...
  return (
    <div className="relative h-64 md:h-96 mb-10 bg-gray-200">
      {/* Slider Image */}
