...
export default function MiddleHomeAd({ section, onImagesChange }) {
  ...
  const loadImages = async () => {
    try {
      ...
      if (!res.ok) {
        console.error(`Failed to load images for section ${section}:`, res.statusText);
        return;
      }
      const data = await res.json();
      setImages(data);
      console.log(`MiddleHomeAd - Loaded ${data.length} images for section ${section}`);
